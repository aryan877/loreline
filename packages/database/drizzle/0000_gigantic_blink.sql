...
CREATE TYPE "public"."book_indexing_status" AS ENUM('pending', 'indexing', 'ready', 'failed');--> statement-breakpoint
...
CREATE TABLE "books" (
	...
	"indexing_status" "book_indexing_status" DEFAULT 'pending' NOT NULL,
	"total_chunks" integer DEFAULT 0 NOT NULL,
	"indexed_chunks" integer DEFAULT 0 NOT NULL,
	"indexing_attempts" integer DEFAULT 0 NOT NULL,
	"indexing_error" text,
	"indexing_updated_at" timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE INDEX "book_chunks_book_user_idx" ON "book_chunks" USING btree ("book_id","user_id");--> statement-breakpoint
